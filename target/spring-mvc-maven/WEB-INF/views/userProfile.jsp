                        ...
                        <div class="col-lg-3">
                            <div class="main-left-sidebar">
                                <div class="user_profile">
                                    <div class="user-pro-img" style="margin-top: 57px">
                            ...
                            <div class="main-ws-sec">
                                ...
                                <div class="product-feed-tab current" id="feed-dd">
                                    <div class="posts-section">
                                        <div class="post-bar">
                                            <div class="job_descp">
                                                <h3 style="padding-top: 20px">Senior Wordpress
                                                    Developer</h3>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing
                                                    elit. Aliquam luctus hendrerit metus, ut ullamcorper quam
                                                    finibus at. Etiam id magna sit amet...</p>
                                                <ul class="skill-tags">
    ...
    <footer>
        <div class="footy-sec mn no-margin">
            <div class="container">
                ...
                <p>
                    <img src="../../static/images/copy-icon2.png" alt="">Copyright
                    2018
                </p>
            </div>
        </div>
...
<script type="text/javascript"
        src="../../static/lib/slick/slick.min.js"></script>
